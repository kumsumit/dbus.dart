...
class DBusIntrospectInterface {
  ...
  XmlNode toXml() {
    ...
    return XmlElement(
        XmlName.parts('interface'), [XmlAttribute(XmlName.parts('name'), name)], children);
  }
...
class DBusIntrospectMethod {
  ...
  XmlNode toXml() {
    ...
    children.addAll(annotations.map((a) => a.toXml()));
    return XmlElement(
        XmlName.parts('method'), [XmlAttribute(XmlName.parts('name'), name)], children);
  }
...
class DBusIntrospectSignal {
  ...
  XmlNode toXml() {
    ...
    children.addAll(annotations.map((a) => a.toXml()));
    return XmlElement(
        XmlName.parts('signal'), [XmlAttribute(XmlName.parts('name'), name)], children);
  }
...
class DBusIntrospectArgument {
  ...
  XmlNode toXml({bool writeDirection = true}) {
    ...
    return XmlElement(
        XmlName.parts('arg'), attributes, annotations.map((a) => a.toXml()).toList());
  }
